...
- [~] 2. Set up project infrastructure and core utilities
  ...
  - [ ] 2.3 Write unit tests for Logger utility
...
- [~] 3. Implement StorageManager for state persistence
  ...
  - [ ] 3.5 Write unit tests for StorageManager
...
- [ ] 6. Implement TabGroupManager for tab group operations
  ...
  - [ ] 6.4 Write unit tests for TabGroupManager
...
- [ ] 7. Implement SnapshotManager for point-in-time backups
  ...
  - [ ] 7.5 Write unit tests for SnapshotManager
...
- [ ] 10. Implement Chrome API event listeners
  ...
  - [ ] 10.4 Write unit tests for event listeners
...
- E2E tests validate real Chrome extension behavior in isolated environments
...
- All tests are required to ensure performance and stability
